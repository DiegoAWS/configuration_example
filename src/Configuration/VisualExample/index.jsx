        ...
        <Div  {...props}>
            <svg style={{ width: '100%' }} xmlns="http://www.w3.org/2000/svg" width="807" height="598" viewBox="0 0 807 598">
                <defs>
                    ...
                    <clipPath id="o">
                        <path className="c" d="M5,0H680a0,0,0,0,1,0,0V447a5,5,0,0,1-5,5H0a0,0,0,0,1,0,0V5A5,5,0,0,1,5,0Z"
                ...
                <g className="d" transform="translate(-1093 -225)">
                    <g transform="translate(1321.7 224.819)">
                        <g transform="translate(14.087)">
                            <ellipse className="e" cx="37.944" cy="37.944" rx="37.944" ry="37.944"
                            ...
                            <path className="g" d="M344.817,589.12c-5.217,3.069-11.438,7.973-18.217,15.848"
                    ...
                    <g transform="translate(-2386 -340)">
                        <g className="al" transform="matrix(1, 0, 0, 1, 3479, 565)">
                            <path className="k" d="M5,0H680a0,0,0,0,1,0,0V447a5,5,0,0,1-5,5H5a5,5,0,0,1-5-5V5A5,5,0,0,1,5,0Z"
                        ...
                        <path className="t" d="M5,0H680a0,0,0,0,1,0,0V42a0,0,0,0,1,0,0H0a0,0,0,0,1,0,0V5A5,5,0,0,1,5,0Z"
                            transform="translate(3689 642)" />
                        ...
                        <g className="ad" transform="translate(3718 693)">
                            ...
                            <path d="M9,4l-.881.881,3.488,3.494H4v1.25h7.606L8.119,13.119,9,14l5-5Z"
                                transform="translate(-1.5 -1.5)" />
                        </g>
                        <g transform="translate(3697 693)">
                            <path className="ac" d="M15,0H0V15H15Z" />
                            <path d="M9,4l.881.881L6.394,8.375H14v1.25H6.394l3.488,3.494L9,14,4,9Z"
                                transform="translate(-1.5 -1.5)" />
                        </g>
                        ...
                        <g transform="translate(3924.893 658.524)">
                            ...
                            <path d="M15.257,10.861h-4.4v4.4H9.4v-4.4H5V9.4H9.4V5h1.465V9.4h4.4Z"
